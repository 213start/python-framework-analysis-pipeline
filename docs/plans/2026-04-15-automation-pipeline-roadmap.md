...
- 第 5 步”数据采集”（合并原步骤 5+6）已完成。三个子步骤：timing/perf/asm，集成 python-performance-kits（git submodule），可选远程执行。
...
### 任务 5+6：数据采集（合并原步骤 5"用例数据获取"和步骤 6"性能采集数据获取"） — ✅ 已完成
